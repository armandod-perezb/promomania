...
/// Modal unificado para editar promociones con todos los campos mejorados.
///
/// Similar a CrearPromoModal pero carga los datos existentes de la promoción.
...
class _EditarPromoModalState extends State<EditarPromoModal> {
  ...
  late final TextEditingController _descripcionTipoController;
  late final TextEditingController _descripcionUbicacionController;
  ...
  double? _latitud;
  double? _longitud;
  late String _condicionProducto;
  late String _tipoVigencia;
  ...
  void initState() {
    super.initState();
    _initializeFromPromocion();
  }

  void _initializeFromPromocion() {
    ...
    // Inicializar estados
    _condicionProducto = promo.condicionProducto;
    _tipoVigencia = promo.tipoVigencia;
    _categoriaId = promo.idCategoria;
  ...
  Future<void> _actualizarPromocion() async {
    ...
    try {
      ...
      final promoActualizada = widget.promocion.copyWith(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _buildTextField(
                    ...
                    readOnly: true, // El código no se puede cambiar
                  ),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: _isLoading ? null : _actualizarPromocion,
                    icon: _isLoading
                        ? const SizedBox(
                            width: 18,
                            height: 18,
