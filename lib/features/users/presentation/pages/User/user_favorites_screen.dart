...
class _MisFavoritosScreenState extends State<MisFavoritosScreen>
      ...
      builder: (context, promoService, child) {
        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle
              .dark, // Establecer estilo de sistema (status bar oscuro)
          child: Scaffold(
  ...
  Widget _buildSavingsCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: _darkBg.withValues(
              alpha: 0.22,
            ), // Sombra del color del fondo
            blurRadius: 12,
        ...
        children: [
          ...
          Container(
            ...
            child: FractionallySizedBox(
              ...
              widthFactor:
                  used /
                  favoritePromos.length.clamp(1, 100), // Porcentaje de progreso
              child: Container(
                decoration: BoxDecoration(
      ...
      child: Row(
        children: [
          ...
          _tabItem(
            1,
            'Por vencer',
          ), // Tab 1: Promociones por vencer (3 días o menos)
  ...
  Widget _buildSwipeCard(Promocion promo) {
    return Dismissible(
      ...
      direction:
          DismissDirection.endToStart, // Solo swipe de derecha a izquierda
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Color(
                      int.parse(
                        categoriaStyle['color']!.replaceFirst('#', '0xFF'),
                      ),
                    ),
                    fontWeight: FontWeight.w600,
                  ),
  ...
  Widget _tabItem(int index, String label) {
    ...
    if (index == 0) {
      ...
      final urgentCount =
          promosByUrgency['today']!.length +
          promosByUrgency['thisWeek']!.length;
