...
class _LoginScreenState extends State<LoginScreen> {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pushReplacementNamed(
          context,
          usuario.rol == 'admin'
              ? AppRoutes.adminDashboard  // Admin va al dashboard
      ...
      child: Column(
        ...
        children: const [
          ...
          Text(
            ...
            style: TextStyle(color: Color(0xFFB0B5CC), fontSize: 13.5),  // Gris claro
          ),
        ],
      ),
    );
  ...
  Widget _buildRememberRow() {
    return Row(
      ...
      children: [
        ...
        Row(
          children: [
            SizedBox(
              ...
              child: Checkbox(
                value: _rememberMe,
                onChanged: (v) => setState(() => _rememberMe = v ?? false),  // Actualizar estado
            ...
            const Text(
              'Recuérdame',
              style: TextStyle(fontSize: 13.5, color: Color(0xFF5A5F72)),  // Gris medio
            ),
          ],
        ),
        ...
        GestureDetector(
          onTap: () {
            Navigator.pushNamed(context, AppRoutes.forgotPassword);  // Navegar a recuperación
          },
          child: const Text(
            '¿Contraseña olvidada?',
            style: TextStyle(
  ...
  Widget _buildDivider() {
    return Row(
      children: const [
        // Línea izquierda
        Expanded(child: Divider(color: Color(0xFFDDE0EA), thickness: 1)),  // Gris muy claro
        // Texto central
        Padding(
          padding: EdgeInsets.symmetric(horizontal: 14),
          child: Text(
            'Or',
            style: TextStyle(color: Color(0xFF8A8FA8), fontSize: 13),  // Gris claro
          ),
        ),
        // Línea derecha
        Expanded(child: Divider(color: Color(0xFFDDE0EA), thickness: 1)),  // Gris muy claro
          ...
          children: [
            ...
            WidgetSpan(
              child: GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, AppRoutes.register);  // Navegar a registro
                },
                child: const Text(
                  'Regístrate',
                  style: TextStyle(
